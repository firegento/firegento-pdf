...
abstract class FireGento_Pdf_Model_Engine_Abstract extends Mage_Sales_Model_Order_Pdf_Abstract
{
    ...
    protected function _insertFooter(&$page)
    {
        ...
        $this->_insertFooterBlock($page, $fields, 60, 35, 180);
        ...
        $this->_insertFooterBlock($page, $fields, 250, 50, 150);
        ...
        $this->_insertFooterBlock($page, $fields, 410, 55, $this->margin['right'] - 410 - 10);
    }
